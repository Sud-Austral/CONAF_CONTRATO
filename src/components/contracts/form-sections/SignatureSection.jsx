    ...
    <div className="p-6 space-y-8 animate-in slide-in-from-right-12 duration-500">
      <div className="space-y-4">
        <label className="text-[11px] uppercase font-black text-conaf-700 tracking-widest font-body flex items-center gap-2">
          ...
          <div className="h-0.5 flex-1 bg-conaf-100" />
        </label>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        {/* Nombre del Firmante */}
        <div className="relative group/field px-4 py-3 bg-white border border-gray-100 rounded-2xl shadow-sm focus-within:border-conaf-400 focus-within:ring-2 focus-within:ring-conaf-100 transition-all">
          ...
          <div className="pl-6 flex flex-col gap-0.5">
            <label className="text-[9px] uppercase font-bold text-gray-400 tracking-wider">Nombre del Responsable</label>
            <input 
              type="text" 
              value={signer.name} 
        ...
        <div className="relative group/field px-4 py-3 bg-white border border-gray-100 rounded-2xl shadow-sm focus-within:border-conaf-400 focus-within:ring-2 focus-within:ring-conaf-100 transition-all">
          ...
          <div className="pl-6 flex flex-col gap-0.5">
            <label className="text-[9px] uppercase font-bold text-gray-400 tracking-wider">Cargo / Departamento</label>
            <input 
              type="text" 
              value={signer.role} 
        ...
        <div className="md:col-span-2 relative group/field px-4 py-3 bg-gray-50/50 border border-gray-100 rounded-2xl shadow-inner cursor-not-allowed">
          ...
          <div className="pl-6 flex flex-col gap-0.5">
            <label className="text-[9px] uppercase font-bold text-gray-400 tracking-wider">Fecha de Validación Sistema</label>
            <input 
              type="date" 
              value={signer.date} 
              readOnly
